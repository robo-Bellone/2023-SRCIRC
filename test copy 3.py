...
def settingGoal_bar():
    ...
    cv2.setTrackbarPos('H2_MAX', 'HSV_settings', 77)
    ...
    cv2.setTrackbarPos('S2_MAX', 'HSV_settings', 255)
    cv2.createTrackbar('S2_MIN', 'HSV_settings', 0, 255, nothing)
    cv2.setTrackbarPos('S2_MIN', 'HSV_settings', 0)
...
if cap.isOpened():                      # 캡쳐 객체 연결 확인
    while True:
        ...
        if ret:
            ...
            cv2.imshow('edge_img', line2_mask)
